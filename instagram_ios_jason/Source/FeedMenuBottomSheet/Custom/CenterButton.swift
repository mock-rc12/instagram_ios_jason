...
class AlignableButton: UIButton {
    var imageEdgeValue: UIEdgeInsets = UIEdgeInsets(top: 12, left: 0, bottom: -12, right: 0)
    var titleEdgeValue: UIEdgeInsets = UIEdgeInsets(top: -12, left: 0, bottom: 12, right: 0)
