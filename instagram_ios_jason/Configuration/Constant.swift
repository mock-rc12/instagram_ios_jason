...
struct Constant {
    ...
    static let pathProfilesEdit = "/profiles/edit/{userIdx}"               //프로필 편집 수정 API
    static let pathProfilesGet = "/profiles/{userIdx}"              // 프로필 조회 API
    static let pathPostFollow = "/:userIdx/follows"           //    팔로우 API
